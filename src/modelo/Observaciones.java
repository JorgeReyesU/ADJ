...
@NamedQueries({
    ...
    , @NamedQuery(name = "Observaciones.findByObsEstado", query = "SELECT o FROM Observaciones o WHERE o.obsEstado = :obsEstado")})
public class Observaciones implements Serializable {
    ...
    public Integer getObsEstado() {
        return obsEstado;
    }

    public void setObsEstado(Integer obsEstado) {
