...
@NamedQueries({
    ...
    , @NamedQuery(name = "Ordenes.findByOrdEstado", query = "SELECT o FROM Ordenes o WHERE o.ordEstado = :ordEstado")})
public class Ordenes implements Serializable {
    ...
    public Integer getOrdEstado() {
        return ordEstado;
    }

    public void setOrdEstado(Integer ordEstado) {
